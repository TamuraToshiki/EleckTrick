...
//
//========================================
void InstancingMeshRenderer::Start()
{
	// インスタンスシングデータの初期化
	m_data.mtxWorld = m_pParent->m_pTrans->GetWorldMatrix();
	m_data.mtxTexture = &this->m_mtxTexture;
	m_data.pPos = m_pParent->m_pTrans->m_pos.GetFloat3();
	m_data.pRot = m_pParent->m_pTrans->m_rot.GetFloat3();
	m_data.pScale = m_pParent->m_pTrans->m_scale.GetFloat3();
}
...
//
//========================================
void InstancingMeshRenderer::End()
{
	// データリストから削除
